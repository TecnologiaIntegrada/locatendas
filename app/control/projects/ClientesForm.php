...
class ClientesForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $nome_do_cliente->addValidation("Nome do cliente", new TRequiredValidator()); 
        ...
        $row1 = $this->form->addFields([new TLabel("Id cliente:", null, '14px', null)],[$id_cliente],[new TLabel("Nome do cliente:", '#ff0000', '14px', null)],[$nome_do_cliente]);
        ...
        $btn_onshow = $this->form->addAction("Back", new TAction(['ClientesList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            TApplication::loadPage('ClientesList', 'onShow', $loadPageParam); 
